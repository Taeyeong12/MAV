    ...
    <div class="container">
        <div class="input-form-backgroud row">
            <div class="input-form col-md-12 mx-auto">
				...
				<form:form modelAttribute="newtournament" class="validation-form" method="post"
				           action="${pageContext.request.contextPath}/tournament/addtournament" onsubmit="return validateForm()">
				    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
				    <div class="row">
				        <!-- 경기날짜 -->
				        <div class="col-md-6 mb-3">
				            <label for="">경기날짜</label>
				            <form:input type="date" path="tournamentDate" name="tournamentDate" class="form-control" />
				        ...
				        <div class="col-md-6 mb-3">
				            ...
				            <form:input type="time" path="tournamentTime" name="tournamentTime" class="form-control" />
				    ...
				    <div class="row">
				        <div class="col-md-6 mb-3">
				            <label for="">상금</label>
				            <form:input type="number" path="tournamentReward" name="tournamentReward" class="form-control"  />
				            <div class="invalid-feedback" id="tournamentRewardFeedback">
				                상금을 입력해주세요
				            </div>
				        </div>
				        ...
				        <div class="col-md-6 mb-3">
				            <label for="">참가비</label>
				            <form:input type="number" path="tournamentPrice" name="tournamentPrice" class="form-control" />
				    ...
				    <div class="row form-group">
				        ...
				        <select name="max_participants" th:field="${newtournament.max_participants}">
