        ...
        <div class="container">
            <div class="input-form-backgroud row">
                <div class="input-form col-md-12 mx-auto">
                    <h4 class="mb-3"> 수정</h4>
                    <form:form modelAttribute="classes" class="form-horizontal" action="/MAV/Class/updateclass" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="classLecturedate" class="form-label">강의날짜</label>
                            ...
                            <div class="mb-3">
                                ...
                                <form:textarea class="form-control" path="classIntroduction" cols="50" rows="10"  value="${classes.classIntroduction}"/>
                            </div>
                            <div class="row">
                                <div class="col-md-6">                               
